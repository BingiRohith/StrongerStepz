...
export interface TestimonialFormInitialValue {
  name?: string;
  message?: string;
  photoUrl?: string;
...
export interface TestimonialFormProps {
  ...
  initialValue?: TestimonialFormInitialValue;
}
...
function buildInitialState(initialValue?: TestimonialFormInitialValue): FormState {
  return {
...
export function TestimonialForm({ mode, testimonialId, initialValue }: TestimonialFormProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const url = mode === "create" ? "/api/testimonials" : `/api/testimonials/${testimonialId}`;
